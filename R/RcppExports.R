...
train_krr <- function(y_train, R_train, D, lambda) {
    .Call(`_KRLS2_train_krr`, y_train, R_train, D, lambda)
}

test_krr <- function(dhat, y_test, R_test) {
    .Call(`_KRLS2_test_krr`, dhat, y_test, R_test)
}

ave_Rsq <- function(X, y) {
    .Call(`_KRLS2_ave_Rsq`, X, y)
}
