...
#' Internal function for estimating marginal effects and their uncertainty
#' 
#' @param obj a 'krls2' object
...
inference.krls2 <- function(obj,
  ...
  z <- append(
    ...
    list(
      ...
      avgsecondderivatives = avgsecondderivatives
    )
  )
